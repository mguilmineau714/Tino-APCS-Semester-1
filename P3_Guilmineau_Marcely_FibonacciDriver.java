...
public class P3_Guilmineau_Marcely_FibonacciDriver {
    public static void main(String[] args) {
        ...
        System.out.println("73 x 4 = " + tests.oneLineTrueMultiplication(73, 4));
         System.out.println("9 x 1 = " + tests.oneLineTrueMultiplication(9, 1));
         System.out.println("3239 x 3232 = " + tests.oneLineTrueMultiplication(3239, 3232));
         System.out.println("-73 x -4 = " + tests.oneLineTrueMultiplication(-73, -4));
         System.out.println("-9 x 1 = " + tests.oneLineTrueMultiplication(-9, 1));
         System.out.println("3239 x -3232 = " + tests.oneLineTrueMultiplication(3239, -3232));
     }
