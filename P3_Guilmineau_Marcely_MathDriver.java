...
public class P3_Guilmineau_Marcely_MathDriver {
    public static void main(String[] args) {
        ...
        double temp3 = 37;
        double temp4 = -15;
        System.out.println(temp1 + "\u00b0" + "C" + " --> " + P3_Guilmineau_Marcely_Math.fToC(temp1) + "\u00b0" + "F");
        System.out.println(temp2 + "\u00b0" + "C" + " --> " + P3_Guilmineau_Marcely_Math.fToC(temp2) + "\u00b0" + "F");
        ...
        double side3 = 2.5;
        double side4 = 9.25;
        System.out.println("A right triangle with sides " + side1 + " and " + side2 + " has hypotenuse " + P3_Guilmineau_Marcely_Math.hypotenuse(side1, side2));
        System.out.println("A right triangle with sides " + side3 + " and " + side4 + " has hypotenuse " + P3_Guilmineau_Marcely_Math.hypotenuse(side3, side4));
